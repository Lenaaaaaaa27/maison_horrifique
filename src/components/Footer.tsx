                    ...
                    <div className="flex flex-col items-center md:items-end">
                        ...
                        <div className="flex space-x-6">
                            <a
                                ...
                                className="hover:text-blue-400 transition duration-300 text-gray-300 hover:scale-110 transform"
                                aria-label="Facebook"
                            >
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="hover:text-pink-500 transition duration-300 text-gray-300 hover:scale-110 transform"
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="hover:text-blue-300 transition duration-300 text-gray-300 hover:scale-110 transform"
                                aria-label="Twitter"
                            >
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
